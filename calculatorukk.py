...
root = Tk()
root.geometry("310x400+300+300")
root.title("Daniels Calc")
...
def btnakar_clicked():
    try:
        ...
        tkinter.messagebox.showerror("Error Boss", "Xek Maning!!!")
...
disp = Entry(root, font="Helvetica 30", fg="white", bg="#2C394B", bd=0, justify=RIGHT, insertbackground="#abbab1", cursor="arrow")
...
pi_btn = Button(btnrow1, text="  π ", font="Segoe 18", relief=GROOVE, bd=0, command=pi_clicked, fg="white", bg="#FF4C29")
pi_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

btn1 = Button(btnrow1, text="1", font="Segoe 23", relief=GROOVE, bd=0, command=btn1_clicked, fg="white", bg="#FF4C29")
btn1.pack(side=LEFT, expand=TRUE, fill=BOTH)

btn2 = Button(btnrow1, text="2", font="Segoe 23", relief=GROOVE, bd=0,  command=btn2_clicked, fg="white", bg="#FF4C29")
btn2.pack(side=LEFT, expand=TRUE, fill=BOTH)

btn3 = Button(btnrow1, text="3", font="Segoe 23", relief=GROOVE, bd=0, command=btn3_clicked, fg="white", bg="#FF4C29")
btn3.pack(side=LEFT, expand=TRUE, fill=BOTH)

btntambah = Button(btnrow1, text="+", font="Segoe 23", relief=GROOVE, bd=0, command=btntambah_clicked, fg="white", bg="#FF4C29")
...
pangkat_btn = Button(btnrow3, text="x^y", font="Segoe 17", relief=GROOVE, bd=0, command=btnpangkat_clicked, fg="white", bg="#FF4C29")
pangkat_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

btn7 = Button(btnrow3, text="7", font="Segoe 23", relief=GROOVE, bd=0, command=btn7_clicked, fg="white", bg="#FF4C29")
btn7.pack(side=LEFT, expand=TRUE, fill=BOTH)

btn8 = Button(btnrow3, text="8", font="Segoe 23", relief=GROOVE, bd=0, command=btn8_clicked, fg="white", bg="#FF4C29")
btn8.pack(side=LEFT, expand=TRUE, fill=BOTH)

btn9 = Button(btnrow3, text="9", font="Segoe 23", relief=GROOVE, bd=0, command=btn9_clicked, fg="white", bg="#FF4C29")
btn9.pack(side=LEFT, expand=TRUE, fill=BOTH)

btnkali = Button(btnrow3, text="*", font="Segoe 23", relief=GROOVE, bd=0, command=btnkali_clicked, fg="white", bg="#FF4C29")
...
titik_btn = Button(btnrow5, text="•", font="Segoe 21", relief=GROOVE, bd=0, command=titik_clicked, fg="white", bg="#FF4C29")
titik_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

hapus_btn = Button(btnrow5, text="⌫", font="Segoe 20", relief=GROOVE, bd=0, command=hapus_clicked, fg="white", bg="#FF4C29")
hapus_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

btnreset = Button(btnrow5, text="C", font="Segoe 23", relief=GROOVE, bd=0, command=btnreset_clicked, fg="white", bg="#FF4C29")
btnreset.pack(side=LEFT, expand=TRUE, fill=BOTH)

btnsamadengan = Button(btnrow5, text="=", font="Segoe 23", relief=GROOVE, bd=0, command=btnsamadengan_clicked, fg="white", bg="#FF4C29")
